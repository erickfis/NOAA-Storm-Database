...
\subsection{Human health: the most harmfull
...
\subsubsection{Fatal Occurrences}\label{fatal-occurrences}
...
\subsubsection{Injuring Occurrences}\label{injuring-occurrences}
